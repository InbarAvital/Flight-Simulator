 ...
 *
 * Returns a list of the splitted text
 */
list<string> lexer(string file_name) {
    ifstream file;
    string data;
    list<string> split_by;
    ...
    while (getline (file, data)) {
        commands = addLists(commands, splitAll(data, split_by));
    }
    file.close();
    return commands;
}
 ...
 *
 * Returns a list of the splitted parts of the string.
 */
list<string> split(string str, string split_by) {
...
/*
 * Arguments: 2 lists of strings
 *
 * Adds the list and sends the update list
 *
 */
...
/*
 * Gets a string and a list of strings and splits the string
 * using the "split" function on each one of the strings in the list.
 *
 ...
 *
 */
list<string> splitAll(string str, list<string> split_by) {
    string final = "";
