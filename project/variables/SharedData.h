...
class SharedData {
 public:
  ...
  SharedData(): symbol_table(new SymbolTable()), interpreter(new Interpreter()) {}
  ...
  // Output: True or false whether if the this variable has right binding or not.
  ...
  VariableInfo *simLeftBinding(const string& sim);
